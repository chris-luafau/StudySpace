  ...
  return function(e) {
        ...
        value: function e(t) {
          if (!t.metaKey) {
            ...
            if (n.method.toLowerCase() != "get") {
              ...
              var s = (0, G.queryAll)("input, select", n);
              if (o.indexOf("?") == -1) {
                o += "?"
              } else {
                o += "&"
    ...
    e.exports = function(e) {
      ...
      return new Promise(function(e, r) {
        if (n.getAddress() != t.currentUrl && !t.cache.exists(n.getAddress())) {
          t.getPage({
            url: n.getAddress()
          }, function(i, o) {
            if (o.status === 500) {
              ...
              var s = t.getDataFromHtml(i, o);
              if (s != null) {
                s.url = n.getAddress();
                t.cache.cacheUrl(s, t.options.debugMode);
